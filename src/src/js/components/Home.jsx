    ...
    render: function() {
        return (
            <div is class="page" id="home">
                ...
                <div is class="bio" flex="row wrap">
                    <div is class="left" flex="row nowrap">
                        ...
                        <div is class="col me fill">
                            ...
                            <ul>
                                <li>Ryan Weiss</li>
                                <li>Web Developer of 15+ years</li>
                                <li>Musician of 20+ years</li>
                                <li>32yrs of age, 150lbs, 5'10"</li>
                            </ul>
                    ...
                    <div is class="right">
                        <div is class="section" id="skills">
                            ...
                            <div is class="skill-types">  
                                <h4>Frontend</h4>
                                <ul>
                                    <li>JavaScript, React.js, Angular.js, Vue.js, Backbone.js, Mithril.js, Marko, ember.js, Knockout.js, HTML5, CSS3, SASS, CSS Flexbox and Grid, Canvas, WebGL, websockets, PWA's and service workers, jQuery, Backbone.js, Bootstrap, CoffeeScript, Handlebars, OAuth, Webpack, gulp, grunt, <a target="_blank" href="/files/resume.pdf">more</a></li>
                                </ul>

                                <h4>Backend</h4>
                                <ul>
                                    <li>node.js, Express.js, PHP, ASP.NET, C#, Python, Java, Kotlin, Laravel, CodeIgniter, ExpressionEngine, Drupal, Wordpress, Directus, MySQL, PostgreSQL, websockets, MongoDB, e-commerce, Git, SSL, nginx, Apache, redis, OAuth, AWS, MVC, CQRS, message queues, continuous integration, unit testing, <a target="_blank" href="/files/resume.pdf">more</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div is class="line-title" id="fulltime"><h3>Latest</h3></div>
